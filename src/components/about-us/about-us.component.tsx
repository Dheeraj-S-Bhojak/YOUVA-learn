...
const AboutUs: React.FC = () => {
  return (
    <div>
      <div className="lg:max-w-full w-full relative inset-0 md:max-w-[744px] max-w-[375px] mx-auto bg-white   ">
        <div className="relative">
          ...
          <div className="absolute lg:bottom-8 md:bottom-3 bottom-0 lg:px-7 md:px-10 px-4 py-4">
            ...
            <p className="lg:text-xl md:text-2xl text-2xl pb-2 leading-9 text-white">
              Our mission is to increase the public's employment and
              understanding of British art from the 16th centuryto present day.
            </p>
      ...
      <div>
        <div className="pt-6 pb-12 bg-gray-00">
          <div id="card" className="">
            <h2 className="text-center font-serif py-32 uppercase text-4xl xl:text-5xl">
              Recent Articles
            </h2>
              ...
              >
                ...
                <div className="w-full py-4 px-6 text-gray-800 flex flex-col justify-between">
                  ...
                  <p className="mt-2">
                    ...
                    Error aut officiis voluptate consequuntur alias tenetur iure
                    maiores, sint dolor sunt eos qui dolores cum temporibus
                    deserunt, quasi repellendus, optio pariatur.
                  </p>
